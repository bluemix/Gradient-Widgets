  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: CustomPaint(
        ...
        child: Center(
          child: Text(
            widget.progress > 100 ? "100\%" : '${(widget.progress).toStringAsPrecision(2)}\%',
...
class RadialPainter extends CustomPainter {
  RadialPainter(
      {required this.bgColor, required this.lineColor, required this.strokeWidth, required this.percent, required this.gradient});
